...
const {
  createMatchRequestSchema, submitResultSchema, respondToRequestSchema,
} = require('../validations/matchRequest.validation');
...
router.patch('/:id/respond',  validate(respondToRequestSchema), controller.respondToRequest);
